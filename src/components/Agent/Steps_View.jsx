                    ...
                    <div className="row clearfix wow fadeInUp">
                        <div className="col-lg-4">
                            <div className="icon-box theme-one ">
                                <div className="icon">
                                    <img src="images/default-color/cloud-computing.png" alt="" className="img-fluid"/>
                                </div>
                                <div className="text">
                        ...
                        <div className="col-lg-4">
                            <div className="icon-box theme-one ">
                                <div className="icon">
                                    <img src="images/default-color/domain.png" alt="" className="img-fluid"/>
                                </div>
                                <div className="text">
                        ...
                        <div className="col-lg-4">
                            <div className="icon-box theme-one ">
                                <div className="icon">
                                    <img src="images/default-color/add-content.png" alt="" className="img-fluid"/>
                                </div>
                                <div className="text">
